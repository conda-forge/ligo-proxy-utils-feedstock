...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ligo-proxy-utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11737&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ligo-proxy-utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ligo-proxy-utils` can be installed with:

```
conda install ligo-proxy-utils
```

It is possible to list all of the versions of `ligo-proxy-utils` available on your platform with:
